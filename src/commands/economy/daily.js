    ...
    async execute(client, interaction) {
        ...
        try {
            ...
            const embed = new discord_js_1.EmbedBuilder()
                ...
                .addFields({ name: "Coins Earned", value: `🪙 **+${result.coins.toLocaleString()}** coins`, inline: true }, { name: "Streak", value: `🔥 Day **${result.streak}**`, inline: true }, { name: "Next Claim", value: `<t:${Math.floor(result.nextClaim.getTime() / 1000)}:R>`, inline: true }, { name: "Streak Status", value: streakText })
