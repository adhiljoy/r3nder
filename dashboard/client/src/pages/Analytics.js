...
const Analytics = () => {
    ...
    if (loading)
        return <div className="p-20 text-center text-white/40">Analyzing community data...</div>;
    // Aggregate totals
    ...
    return (<div className="space-y-10 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass-card p-6 flex items-center gap-6">
                    <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center text-primary">
                        <lucide_react_1.MessageSquare size={28}/>
                    </div>
                    <div>
                ...
                <div className="glass-card p-6 flex items-center gap-6">
                    <div className="w-14 h-14 rounded-2xl bg-green-500/10 flex items-center justify-center text-green-400">
                        <lucide_react_1.TrendingUp size={28}/>
                    </div>
                    <div>
                ...
                <div className="lg:col-span-2 glass-card p-8 flex flex-col gap-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <lucide_react_1.BarChart3 className="text-primary"/>
                    ...
                    <div className="h-[300px] w-full">
                        <recharts_1.ResponsiveContainer width="100%" height="100%">
                            <recharts_1.LineChart data={data}>
                                ...
                                <recharts_1.XAxis dataKey="name" axisLine={false} tickLine={false} tick={{ fill: '#ffffff40', fontSize: 12 }} dy={10}/>
            ...
            fontSize: '12px'
                                ...
                                <recharts_1.Line type="monotone" dataKey="messages" stroke="#5865F2" strokeWidth={4} dot={{ fill: '#5865F2', r: 4 }} activeDot={{ r: 8, stroke: '#5865F220', strokeWidth: 10 }}/>
                                <recharts_1.Line type="monotone" dataKey="activeUsers" stroke="#C392FF" strokeWidth={4} dot={{ fill: '#C392FF', r: 4 }} activeDot={{ r: 8, stroke: '#C392FF20', strokeWidth: 10 }}/>
                ...
                <div className="glass-card p-8 flex flex-col gap-8">
                    ...
                    <div className="flex-1 space-y-6">
                        {topCommands.length > 0 ? (topCommands.map((cmd, i) => (<div key={cmd.name} className="space-y-2">
                ...
                backgroundColor: COLORS[i % COLORS.length]
                                ...
                                </div>))) : (<div className="h-full flex items-center justify-center text-white/20 text-sm italic">
                                No command data yet...
                            </div>)}
                    </div>
